...
//    }
    ...
    public void showImage(Message msg, boolean fromSelf) {
        showImage(panel_Msg, msg, fromSelf);//先显示到聊天内容面板
        showImage(panel_Record, msg, fromSelf);//再显示到聊天记录面板
    }
//    public void showGroupMessage(Message msg, boolean fromSelf) {
//        showGroupMessage(panel_Msg, msg, fromSelf);//先显示到聊天内容面板
//        showGroupMessage(panel_Record, msg, fromSelf);//再显示到聊天记录面板
//    }
    /**
     * 将消息内容显示到指定面板
     * @param jtp
